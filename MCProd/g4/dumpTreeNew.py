    ...
    for jentry in tqdm(range(entries)):
        ...
        for containerName, hitSegments in event.SegmentDetectors:
            ...
            for iHit, hitSegment in enumerate(hitSegments):
                ...
                segment[iHit]["t"] = 0
                segment[iHit]["dEdx"] = (hitSegment.GetEnergyDeposit() - hitSegment.GetSecondaryDeposit()) / dx if dx > 0 else 0
                segment[iHit]["dE2dx"] = hitSegment.GetSecondaryDeposit() / dx if dx > 0 else 0
